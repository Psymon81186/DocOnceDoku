...
{\Large\textsf{Simon${}^{}$}}\\ [3mm]

{\Large\textsf{Michael${}^{}$}}\\ [3mm]
...
\Verb!_ _!                                               & Fett                \\
````                                                     & Code                \\
\Verb!\href{{http://google.com}}{Search Google}!         & Link                \\
\texttt{------}                                            & horizontale Linie   \\
` & `                                                    & kaufmännisches Und \\
\Verb!\shortinlinecomment{name 1}{ comment }{ comment }! & Kommentar           \\
